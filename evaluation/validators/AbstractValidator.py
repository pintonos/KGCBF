...
class AbstractValidator:
    ...
    def evaluate_errors(self, report_location: str = "data/report.yaml") -> Report:
        ...
        @return: The KGCBF report generated by the evaluation.
        """
        # Generally, the below code should work just fine, if validate_file is implemented appropriately
        # and if the approach_dictionary is defined properly. Simply uncomment it and place it in your subclass.
        self.validate_file()
